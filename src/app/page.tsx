  ...
  return (
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <main className="flex-1">
        ...
        <section className="relative flex items-center min-h-[600px] lg:min-h-[700px]">
          {/* Background Image */}
          <div
          ...
          <div className="absolute inset-0 z-10 bg-gradient-to-r from-[#0F2044]/95 via-[#0F2044]/80 to-transparent" />

          <div className="container relative z-20 mx-auto px-4 lg:px-8 max-w-6xl">
            <div className="max-w-2xl space-y-8">
              ...
              <div className="pt-4">
                <ContactModal>
                  <button className="bg-[#2C6E9E] hover:bg-[#2C6E9E]/90 text-white h-14 px-8 rounded-md font-medium text-lg transition-colors inline-flex items-center justify-center shadow-lg hover:shadow-xl">
        ...
        <section id="servicios" className="py-20 lg:py-28 bg-[#F8F9FB]">
          <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="group relative rounded-2xl overflow-hidden aspect-[4/5] shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                <div
